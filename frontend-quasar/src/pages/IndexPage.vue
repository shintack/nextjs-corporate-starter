            ...
            >
              <div class="custom-caption">
                <div class="text-h2 main_line animation_2">
                  WELCOME TO <span :style="'color:' + theme_color">KUDOS</span>
                </div>
                <br /><br /><br />
          ...
          >
            ...
            >
              <div class="custom-caption">
                ...
                >
                  <span :style="'color:' + theme_color">KUDOS</span> FOR THE
                  BEST
                </div>
                <br /><br /><br />
                <div class="text-h4 animation_1">
        ...
        >
          <div class="q-pa-sm q-gutter-sm">
            ...
            <q-btn
              round
              type="a"
              href="https://github.com/mayank091193/vue-quasar-company-profile-website"
              :style="
                'background:' + theme_color + '; color: white !important;'
              "
              icon="fab fa-github"
            ...
            <q-btn
              round
              type="a"
              href="mailto:mayank091193@gmail.com"
              :style="
                'background:' + theme_color + '; color: white !important;'
              "
              icon="email"
